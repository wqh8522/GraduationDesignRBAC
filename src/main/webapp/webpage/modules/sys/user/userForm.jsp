		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		       <tr>
		         ...
		         <td class="width-35">
					 <sys:treeselect id="role" name="role.id" value="${user.role.id}" labelName="role.name" labelValue="${user.role.name}"
						title="角色" url="/sys/role/treeData?type=1" cssClass="form-control required" checked="true" smallBtn="false" hideBtn="false"/></td>
		      </tr>
		      <tr>
		      ...
		      <tr>
				  <td class="active">
					  <label class="pull-right"><font color="red">*</font>姓名:</label></td>
		         ...
		         <td>
					 ...
					 <form:input path="loginName" htmlEscape="false" maxlength="50" class="form-control"/></td>
		      </tr>
