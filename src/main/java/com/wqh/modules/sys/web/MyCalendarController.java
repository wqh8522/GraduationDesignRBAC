...
import com.wqh.modules.sys.service.MyCalendarService;
import com.wqh.modules.sys.utils.DateUtil;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/sys/myCalendar")
public class MyCalendarController extends BaseController {
	...
	public String index(MyCalendar myCalendar, HttpServletRequest request,
		...
		return "modules/sys/calendar/myCalendar";
	}
	...
	public String addform(MyCalendar myCalendar, HttpServletRequest request,
		...
		return "modules/sys/calendar/myCalendarForm-add";
	}
	...
	public String editform(MyCalendar myCalendar, HttpServletRequest request,
		...
		return "modules/sys/calendar/myCalendarForm-edit";
	}

	@RequiresPermissions("user")
	@ResponseBody
	@RequestMapping(value = "findList")
	protected List doPost(MyCalendar myCalendar,
