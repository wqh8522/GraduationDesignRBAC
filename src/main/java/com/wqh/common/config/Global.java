...
public class Global {
	 ...
	 * @see ${fns:getSystemName()}
	 */
	public static String getSystemBack() {
		SystemConfigService systemConfigService = SpringContextHolder.getBean(SystemConfigService.class);
		SystemConfig config = systemConfigService.get("1");
		return config.getLoginback();
	}

	/**
	 * 获取系统名称
	 * @see ${fns:getSystemLogo()}
	 */
	public static String getSystemLogo() {
		SystemConfigService systemConfigService = SpringContextHolder.getBean(SystemConfigService.class);
		SystemConfig config = systemConfigService.get("1");
		return config.getSyslogo();
	}
...
//		System.out.println("userfiles.basedir: " + dir);
	...
	public static void modifyConfig(String key, String value) {
		try {
			...
			String path = Global.class.getResource("/system.properties").getPath();
	...
	public static Properties getProperties(){
		...
		try {
			Reader reader = Resources.getResourceAsReader("/system.properties");
			prop.load(reader);
		} catch (Exception e) {
			return null;
		}
